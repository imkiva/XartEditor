 ...
 */
public class LanguageToken implements Serializable, Comparable {

    public final LanguageTokenType type;
     ...
     * @param length
     */
    public LanguageToken(LanguageTokenType type, int start, int length) {
        this.type = type;
        this.start = start;
        this.length = length;
        this.pairValue = 0;
     ...
     * @param pairValue
     */
    public LanguageToken(LanguageTokenType type, int start, int length, byte pairValue) {
        this.type = type;
        this.start = start;
        this.length = length;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Object) {
            ...
            return ((this.start == languageToken.start) &&
                    (this.length == languageToken.length) &&
                    (this.type.equals(languageToken.type)));
        } else {
            return false;
        }
    }
    ...
    public int compareTo(Object o) {
        LanguageToken t = (LanguageToken) o;
